...
<!-- Modal -->
       ...
       <div class="panel panel-default" >
        <div class="panel-heading">ค้นหารายรับชำระเงินประจำเดือน</div>
          <div class="panel-body">

                <form class="form-horizontal" id = "search" name = "search"  method="post" action="" role="form" style = "font-size:12px;">
                   <?php  
                      
                        $condtion ="1&Month={$_POST['monthbill']}&Year={$_POST['yearbill']}&Floor={$_POST['Floor']}";
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding"> 
                ...
                <a  id ="print" name ="print"   href = "../reporttopdf/report03.php?codition=<?php echo $condtion; ?>" target="_blank"><img src = "images/pdf.png"></img></a>&nbsp;&nbsp;&nbsp;
                <a  id ="print" name ="print"   href = "excelreport03.php?codition=<?php echo $condtion; ?>" target="_blank"><img src = "images/xlsx.png"></img></a>
              </div>
         ...
         if(is_array($_POST) && $_POST){
            ...
            $sql = "SELECT * FROM MasterInvoice WHERE 1 = 1 AND  BillDate != '000-00-00'";
             ...
             if( $_POST['monthbill'] != "" &&  $_POST['yearbill'] != "" &&  $_POST['Floor'] != ""  ) {  
 
               $sql .=" AND Month = '".$_POST['monthbill']."' AND  Year = '".$_POST['yearbill']."'  AND  Floor = '".$_POST['Floor']."'";
            }

               $sql .=" ORDER BY Room ASC ";

               //echo $sql;
          //echo $ey  = $_POST['yearbill']+543;
