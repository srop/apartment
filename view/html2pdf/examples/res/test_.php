...
for($i = 1; $i<= 1; $i++){
  ...
  ?>
<page style="font-size: 15px;font-family:freeserif"  >
    <br> 
    <div class="special">
        <table>
            <tr>
                <td height="30" colspan="2" style="width: 100%; text-align:left">บริษัทไพรเงินจำกัด  เเลขที่ผู้เสียภาษี 3 10 182672 3.</td>
            </tr>
            <tr>
    ...
    <table style="width: 100%; border: solid 1px #FFFFFF;">
        ...
        <tr>
         ...
         <tr>
          ...
          <tr>
            <td height="50" style="width: 30%; vertical-align: middle;"> รวมทั้งสิ้น</td>
    ...
    <div class="special-1">
      <table >
          ...
          <tr >
                <td  height="20"style="width:50%;text-align:left;  vertical-align: middle;">ออก ณ</td>
                <td  height="20" style="width: 50%; text-align:left; vertical-align: middle;">ผู้รับเงิน</td>
            </tr>
     ...
     <div class="special-1">
      <table >
          ...
          <tr >
            ...
            <tr >
                 <td colspan="2" style="padding-top:20px; width: 100%; text-align:left;border-bottom:1px dashed #000000; vertical-align: bottom;"></td>
            </tr>
